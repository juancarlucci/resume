...
var HTMLtwitter = '<li class="flex-item"><span class="orange-text">twitter </span><a href="#" target="_blank" class="white-text">%data%</a></li>';
// var HTMLlinkedin = '<li class="flex-item"><span class="orange-text">linkedin</span><span class="white-text">%data%</span></li>';
var HTMLlinkedin = '<li class="flex-item"><span class="orange-text">linkedin </span><a href="#" target="_blank" class="white-text">%data%</a></li>';

// var HTMLlinkedinlURL = '<h4><br><a href="#" target="_blank">%data%</a></h4>';
...
var HTMLwelcomeMsg = '<br><br><span class="lead welcome-message">%data%</span>';
    ...
    "contacts": {
        ...
        "linkedin": 
            [{
             ...
             "url": "https://www.linkedin.com/in/juancarloscollins" 
         }],
        "github": 
             [{
             "title": "juancarlucci",
             "url": "https://github.com/juancarlucci" 
         }],
...
bio.display = function() {
    ...
    $("#title").prepend(formattedBioPic);
    var formattedwelcomeMsg = HTMLwelcomeMsg.replace("%data%", bio.welcomeMessage);
    $("#title").append(formattedwelcomeMsg);
    ...
    var formattedbioGithub = HTMLgithub.replace("%data%", bio.contacts.github[0].title);
    var finaGithubLink = formattedbioGithub.replace('#', bio.contacts.github[0].url);
    $("#topContacts").append(finaGithubLink);
    $("#footerContacts").append(finaGithubLink);
    var formattedbioLinkedin = HTMLlinkedin.replace("%data%", bio.contacts.linkedin[0].title);
    var finaLinkedinLink = formattedbioLinkedin.replace('#', bio.contacts.linkedin[0].url);
    $("#topContacts").append(finaLinkedinLink);
    $("#footerContacts").append(finaLinkedinLink);


    // var formattedProjectlLink = HTMLprojectlURL.replace("%data%", projects.projects[project].title);
    // var finaLinkedinLink = formattedProjectlLink.replace('#', projects.projects[project].url);
...
$('.more-info').each (function(){
  $('.projectCard').toggleClass('flip');
  $('#arrow').remove();
});
$('#projectBackground').click(function(){
  $('.projectCard').removeClass('flip');
});
